...
Exposed hooks:
  ...
  hook_millennium_marc_to_biblio_alter($biblio, $context)

  Lets other modules change the biblio data when it's converted from MARC
  (usually during imports).

     where:
       $biblio is a bibliographic data array.
       $context array containing MARC in raw and text versions.
