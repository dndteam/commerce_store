 ...
 * @see html.tpl.php
 */
function bookstore_preprocess_html(&$variables) {
  ...
  drupal_add_library('bookstore', 'selectnav');
}

/**
 * Implements hook_library().
 */
function bookstore_library() {
 ...
 */
function bookstore_preprocess_node(&$variables) {
